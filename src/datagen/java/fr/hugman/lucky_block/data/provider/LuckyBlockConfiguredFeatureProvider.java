...
public class LuckyBlockConfiguredFeatureProvider extends FabricDynamicRegistryProvider {
    ...
    public static void register(Registerable<ConfiguredFeature<?, ?>> registerable) {
        ...
        of(registerable, LuckyBlockConfiguredFeatures.SURFACE_LUCKY_BLOCKS, Feature.RANDOM_PATCH, ConfiguredFeatures.createRandomPatchFeatureConfig(Feature.SIMPLE_BLOCK, new SimpleBlockFeatureConfig(BlockStateProvider.of(LuckyBlocks.LUCKY_BLOCK)), List.of(Blocks.GRASS_BLOCK)));
