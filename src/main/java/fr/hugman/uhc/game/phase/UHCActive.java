package fr.hugman.uhc.game.phase;

import fr.hugman.text.Messenger;
import fr.hugman.uhc.UHC;
import fr.hugman.uhc.config.UHCGameConfig;
import fr.hugman.uhc.game.*;
import fr.hugman.uhc.modifier.Modifier;
import fr.hugman.uhc.modifier.ModifierType;
import fr.hugman.uhc.modifier.PermanentEffectModifier;
import fr.hugman.uhc.modifier.PlayerAttributeModifier;
import fr.hugman.uhc.module.Module;
import fr.hugman.uhc.module.ModuleEvents;
import fr.hugman.uhc.util.TickUtil;
