 ...
 * @since 1.0.0
 */
public record LootTableLuckyEvent(NbtComponent data) implements LuckyEvent {
    public static final MapCodec<LootTableLuckyEvent> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
            NbtComponent.CODEC.optionalFieldOf("data", NbtComponent.DEFAULT).forGetter(LootTableLuckyEvent::data)
    ).apply(instance, LootTableLuckyEvent::new));
